...
class PatientsManagementScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<PatientsManagementScreen> createState() => _PatientsManagementScreenState();
}

class _PatientsManagementScreenState extends ConsumerState<PatientsManagementScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton.extended(
        heroTag: "patients_management_fab",
